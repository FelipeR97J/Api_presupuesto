...
/**
 * MODELO: IncomeCategory
 * 
 * Tabla que almacena las categorías de ingresos disponibles
 * Las categorías son predefinidas pero pueden ser administradas
 * 
 * RELACIÓN: Una categoría tiene MUCHOS ingresos (One-to-Many)
 */
export const IncomeCategory = sequelize.define(
  'IncomeCategory',
  {
    ...
    // Campo Name: Nombre de la categoría (ej: "Salario", "Bono", "Freelance", etc)
    name: {
  ...
  {
    tableName: 'income_categories', // Nombre de la tabla en MySQL
